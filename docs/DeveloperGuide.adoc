...
* If the total profit is negative, a special `NegativePrice` object is used to wrap the value.
**

The sum of costs is then wrapped in a `Price` object and returned to the calling function.
